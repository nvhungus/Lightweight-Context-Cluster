...
REFERENCE = Experiment(
    name="resnet18_reference_cifar100",
    config="configs/cifar100/resnet18_reference_cifar100.yaml",
    kind="reference",
)

CE_EXPERIMENTS = [
    Experiment("hbcc_small_no_mix_cifar100", "configs/cifar100/hbcc_small_no_mix_cifar100.yaml"),
    Experiment("hbcc_small_light_aug_cifar100", "configs/cifar100/hbcc_small_light_aug_cifar100.yaml"),
    Experiment("hbcc_medium_light_aug_cifar100", "configs/cifar100/hbcc_medium_light_aug_cifar100.yaml"),
]

KD_EXPERIMENTS = [
    Experiment(
        "hbcc_small_kd_cifar100",
        "configs/cifar100/hbcc_small_light_aug_cifar100.yaml",
        kind="kd",
        teacher=True,
        overrides=("experiment.name=hbcc_small_kd_cifar100", "train.kd_alpha=0.2", "train.kd_temperature=4.0"),
    ),
    Experiment(
        "hbcc_medium_kd_cifar100",
        "configs/cifar100/hbcc_medium_light_aug_cifar100.yaml",
        kind="kd",
        teacher=True,
        overrides=("experiment.name=hbcc_medium_kd_cifar100", "train.kd_alpha=0.2", "train.kd_temperature=4.0"),
    ),
]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the full CIFAR-100 experiment matrix.")
