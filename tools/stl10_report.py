...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect STL-10 train/test and benchmark metrics into one CSV.")
    parser.add_argument("--runs", default="runs_stl10")
    parser.add_argument("--benchmarks", default="results/benchmark_stl10")
    parser.add_argument("--output", default="results/stl10_summary.csv")
